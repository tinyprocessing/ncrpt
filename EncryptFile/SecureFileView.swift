        ...
        ZStack(alignment: .bottom) {
            ...
            Button(
                action: {
                    ...
                    let template = pvm.templates.first {
                        $0.id == pvm.selectedTemplated
                    }
                    if template != nil {
                                ...
                                Settings
                                    ...
                                    .alert(
                                        title:
                                            "Success",
                                        message:
                                            "Your files are protected, you can find them on home page"
                                    )
                                self.pvm
                                    .clear()
                                self
                                ...
                                Settings
                                    ...
                                    .alert(
                                        title:
                                            "Error",
                                        message:
                                            "File is not protected, try again later"
                                    )
                            }
                        }
                    }
