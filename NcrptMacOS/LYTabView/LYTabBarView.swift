...
public class LYTabBarView: NSView {
    ...
    private func setupViews() {
        ...
        addTabButton = buildBarButton(image: NSImage(named: "home"),
                                      action: #selector(addNewTab))

        outterStackView.addView(packedTabButton, in: .bottom)
        outterStackView.addView(addTabButton, in: .top)
...
//            self.animatorOrNot().isHidden = count < 1
//        }
        self.animatorOrNot().isHidden = false
    }
    ...
    private func createLYTabItemView(_ item: NSTabViewItem) -> LYTabItemView {
        ...
        NSLayoutConstraint.activate([
            tabItemView.centerXAnchor.constraint(equalTo: tabItemView.centerXAnchor),
            tabItemView.centerYAnchor.constraint(equalTo: tabItemView.centerYAnchor),
         ])
